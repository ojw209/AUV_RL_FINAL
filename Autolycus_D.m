classdef Autolycus_D < rl.env.MATLABEnvironment
    ...
    methods              
        ...
        function this = Autolycus_D()
            ...
            ActionInfo.Description = 'INDEX: Nothing, TStbd, Taft, Tport, Tfore, TStbd & Tport, Tfore & Taft, -TStbd, -Taft, -Tport, -Tfore, -TStbd & -Tport, -Tfore & -Taft';
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action)
            ...
            X0 = [u,v,w,p,q,r,x,y,z,phi,theta,psi,Tstbd, Taft, Tport, Tfore];
            dt = 0.025;
            tspan = [0:dt:0.1];
            ...
            %disp([Observation(7) Observation(8) Observation(9)])
